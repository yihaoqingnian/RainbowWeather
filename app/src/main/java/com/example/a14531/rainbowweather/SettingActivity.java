...
public class SettingActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void shareSoftwareMsg(String s) {
        ...
        startActivity(Intent.createChooser(intent,"彩虹天气"));
    }
    ...
    private void clearCache() {
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(SettingActivity.this,"已清除全部缓存！",Toast.LENGTH_SHORT).show();
...
//                获取目前的默认壁纸
                ...
                switch (checkedId) {
                    case R.id.more_rb_green:
                        if (bg==0) {
                            Toast.makeText(SettingActivity.this,"您选择的为当前背景，无需改变！",Toast.LENGTH_SHORT).show();
                            return;
                        }
                        editor.putInt("bg",0);
                        editor.commit();
